...
const form = ref<StockOut>({
    stock_out_number: props.stock_out_number,
    supplier_id: null,
    user_id: props.currentUser?.id || null,
    out_date: tanggalPengeluaranBarang,
    user_ack_id: null,
    ack_date: null,
    user_reject_id: null,
    reject_date: null,
...
const submitForm = () => {
    ...
    stockOutStore.createStockOut(form.value);
};
</script>
                        ...
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <BaseButton @click="openAddProductModal" type="button" color="blue"
                                        text="Tambah Barang" />
                                </div>
                            ...
                            <div class="flex items-center justify-end space-x-3 pt-4">
                                ...
                                <BaseButton :disabled="!isFormValid || isSubmitting || stockOutStore.isLoading"
                                    :loading="isSubmitting || stockOutStore.isLoading" text="Simpan Pengeluaran"
