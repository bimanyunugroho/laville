...
const handleSubmit = () => {
    unitStore.editUnit(props.unit.slug, updatedUnit.value);
};
</script>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="handleSubmit" class="max-w-full space-y-6">
                            <TextInput id="code" v-model="updatedUnit.code" label="Kode Satuan"
                                placeholder="Masukkan kode satuan" required />
