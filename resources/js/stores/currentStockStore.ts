import { CurrentStock, CurrentStockPageProps, CurrentStockPagination, PaginationLink } from '@/types/current_stock';
...
export const useCurrentStockStore = defineStore('current_stocks', {
    state: (): CurrentStockState => ({
        current_stocks: {
            data: [] as CurrentStock[],
    ...
    actions: {
        initializeFromProps(props: CurrentStockPageProps) {
            this.current_stocks = props.current_stocks;
        ...
        debouncedSearch: debounce(function(this: any) {
            this.isLoading = true;
            router.get(
                route('admin.inventory.current_stock.index'),
                {
